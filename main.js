...
ctx.lineWidth= 1;
ctx.rect(150, 150, width="230", height="200");
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(250, 200, 30 ,0, 2 * Math.PI ,360);
ctx.stroke();
...
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(300, 200, 30,0, 2 * Math.PI ,360);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(275, 225, 30, 0 , 2 * Math.PI );
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "purple";
ctx.lineWidth = 5;
ctx.arc(325, 225, 30, 0 , 2 * Math.PI );
ctx.stroke();